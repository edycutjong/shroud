// Initialize Shroud's on-chain verifier contract with the current vk.json/fixture.json:
...
const VERIFIER = process.env.VERIFIER_ID || "CCHBJVLXAXPXSJCMRCNVWDZ3WTHCF2DRLFB5DQYGTL6PKROBPOKGBK5M";
